...
#define MYPORT  16996
#define IPADDR  "221.12.156.125"
#define BUFFER_SIZE 1024
SOCKET sclient;
char api[]="/common_front/checkneedless/user/logon/logon.action ";
char hostname[]="221.12.156.125:16996";
char retcode[128];
...
int _tmain(int argc, _TCHAR* argv[])
{
		...
		char recvbuf[BUFFER_SIZE];
			...
			strcat(send_str, hostname);
			strcat(send_str, "\r\n");
			strcat(send_str, "Content-Length:292\r\n");
			//strcat(send_str, "Expect: 100-continue\r\n");
			strcat(send_str, "Connection: Keep-Alive\r\n\r\n");
			

			
			strcat(send_str, "<?xml version=\"1.0\" encoding=\"gb2312\"?><GNNT><REQ name=\"logon\"><USER_ID>803300000010212</USER_ID><PASSWORD>418331101</PASSWORD><REGISTER_WORD>201609212155437710180000000015488012.14774934507</REGISTER_WORD><VERSIONINFO></VERSIONINFO><LA>0</LA><L_M></L_M><LOGONTYPE>pc</LOGONTYPE></REQ></GNNT>");

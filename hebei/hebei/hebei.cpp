...
#define MYPORT  16915
#define IPADDR  "123.59.182.100"
#define BUFFER_SIZE 1024
SOCKET sclient;
char api[]="/issue_tradeweb/httpXmlServlet ";
char hostname[]="123.59.182.100:16915";
char retcode[128];
...
int _tmain(int argc, _TCHAR* argv[])
{
		...
		char recvbuf[BUFFER_SIZE];
			...
			strcat(send_str, hostname);
			strcat(send_str, "\r\n");
			strcat(send_str, "Content-Length:262\r\n");
			//strcat(send_str, "Expect: 100-continue\r\n");
			strcat(send_str, "Connection: Keep-Alive\r\n\r\n");
			

			
			strcat(send_str, "<?xml version=\"1.0\" encoding=\"gb2312\"?><GNNT><REQ name=\"logon\"><USER_ID>1299906727</USER_ID><PASSWORD>418331101</PASSWORD><REGISTER_WORD>20160925143000789129990672780170.01900402746</REGISTER_WORD><VERSIONINFO></VERSIONINFO><LOGONTYPE>pc</LOGONTYPE></REQ></GNNT>");
